...
def get_match_events(matches_df, client_id, client_secret, season_ids, country, match_dict):
    ...
    # Initialize an empty set for storing existing match IDs
    ...
    for season_id in season_ids:
        ...
        for match_wy_id in group['matchId']:
            ...
            # Check if matchId is already in the set of processed match IDs
            if match_wy_id in existing_match_ids:
                print(f"  Skipping match ID: {match_wy_id} (already in set of processed IDs)")
                continue
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    if 'events' in match_event_data:
                        ...
                        # Add the processed match ID to the set
                        existing_match_ids.add(match_wy_id)
                    else:
